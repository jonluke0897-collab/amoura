...
export const SIGN_IN = {
  ...
  logInCta: 'Log in with password',
  logInSheetTitle: 'Log in',
  logInSheetHelp: 'For accounts with a password set.',
  passwordInputPlaceholder: 'Password',
  logInSubmitCta: 'Log in',
  logInFailed: 'That email and password didn\u2019t match an account.',
  authUnexpected: 'Something went wrong. Please try again.',
  codeSendFailed: 'Could not send the code. Please try again.',
  codeVerifyFailed: 'Could not verify the code. Please try again.',
